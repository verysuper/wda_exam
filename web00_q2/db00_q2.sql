...
CREATE TABLE `article` (
  ...
  `a_cont` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `a_look` int(1) NOT NULL
...
CREATE TABLE `q2_member` (
  `q_m_seq` int(10) UNSIGNED NOT NULL,
  `q_m_id` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `q_m_pw` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `q_m_mail` text COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
