...
<div style="width:630px;min-height:320px;margin:0 auto;">
  <fieldset class="mm" onclick="opmenu('a1');">健康新知</fieldset>
  <fieldset class="mm" onclick="opmenu('a2');">菸害防治</fieldset>
  <fieldset class="mm" onclick="opmenu('a3');">癌症防治</fieldset>
  <fieldset class="mm" onclick="opmenu('a4');">慢性病防治</fieldset>
  <fieldset id="apple">
