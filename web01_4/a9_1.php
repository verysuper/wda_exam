<?php
  if(isset($_POST['a9_11'])){
      $sql="INSERT INTO `menu` VALUES(null,'{$_POST['name']}','{$_POST['href']}','0','1')";
      $conn->query($sql);
  }
  if(isset($_POST['a9_1'])){
...
<tr>
<td width="200px">
<input type="button" onclick="op('#cover','#cvr','a9_11.php')" value="新增主選單"></td><td class="cent">
<input type="submit" value="修改確定" name="a9_1">
