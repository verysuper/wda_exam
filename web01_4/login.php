<?php
	...
	if(isset($_POST['login'])){
		...
		if($conn->query($sql)->fetchAll(PDO::FETCH_ASSOC)){
...
<div class="di" style="height:540px; border:#999 1px solid; width:53.2%; margin:2px 0px 0px 0px; float:left; position:relative; left:20px;">
                    ...
                    <div style="height:32px; display:block;"></div>
                        			...
                        			<p class="cent">帳號 ： <input name="acc" autofocus="" type="text" required></p>
                        	        <p class="cent">密碼 ： <input name="ps" type="password" required></p>
                        	        <p class="cent"><input value="送出" type="submit" name="login"><input type="reset" value="清除"></p>
                        	    </form>
                        	                </div>
