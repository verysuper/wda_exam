...
INSERT INTO `admins` (`id`, `acc`, `pw`, `type`) VALUES
(1, 'admin', '1234', 0),
(2, 'aaa', 'aaa', 1);
...
INSERT INTO `menus` (`id`, `menu`, `display`, `parent`, `href`) VALUES
(1, '管理登入', 1, 0, 'login.php'),
(2, '網站首頁', 1, 0, 'index1.php'),
(3, 'index2', 1, 2, 'index2.php'),
(4, 'index3', 1, 2, 'index3.php'),
(5, 'test1', 1, 1, 'test1.php');
...
(2, '01B02.jpg', '01B02.jpg', 0),
(3, '01B03.jpg', '01B03.jpg', 0),
(4, '01B04.jpg', '01B04.jpg', 0);
