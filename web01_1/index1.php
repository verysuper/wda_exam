<?php
	...
	$mvimArr=$conn->query($sql)->fetchAll(PDO::FETCH_ASSOC);
	$imgStr="";
	foreach($mvimArr as $img){
		$imgStr.="'{$img['mvim']}',";
	}
	...
	$newsLen=count($newsArr);
	$newsStr="";
	for($i=0;$i<5;$i++){
		$newsStr.="<li>".mb_substr($newsArr[$i]['news'],0,10)."...<div class='all' style='display:none;'>{$newsArr[$i]['news']}</div></li>";
	}
?>
        	...
        	<div id="ms">
                ...
                <div class="di" style="height:540px; border:#999 1px solid; width:53.2%; margin:2px 0px 0px 0px; float:left; position:relative; left:20px;">
                	...
                	<div style="width:95%; padding:2px; height:190px; margin-top:10px; padding:5px 10px 5px 10px; border:#0C3 dashed 3px; position:relative;">
                    		<span class="t botli">最新消息區<span style='float:right;'><?=$newsLen>5?"<a href='news.php'>More...</a>":"";?></span>
                            								</span>
